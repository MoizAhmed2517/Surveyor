...
const BannerCard = () => {
  return (
    <Grid container spaxing={3} justifyContent="center">
        <Grid item xs={12} sm={12} md={4}>
            <img src={banner1} style={{ maxWidth: '100%', height: 'auto', objectFit: 'cover' }} />
            ...
            <Button sx={{ justifyContent: 'center', display: 'flex', margin: '15px auto' }}>Learn More</Button>
        </Grid>
        <Grid item xs={12} sm={12} md={4}>
            <img src={banner2} style={{ maxWidth: '100%', height: 'auto', objectFit: 'cover' }}  />
        ...
        <Grid item xs={12} sm={12} md={4}>
            <img src={banner3} style={{ maxWidth: '100%', height: 'auto', objectFit: 'cover' }}  />
